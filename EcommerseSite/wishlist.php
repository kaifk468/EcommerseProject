                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
										...
										?>
											<tr>
												<td class="product-thumbnail wishlist"><a href="#"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$row['image']?>"  /></a></td>
												<td class="product-name wishlist"><a href="#"><?php echo $row['name']?></a>
													<ul  class="pro__prize">
